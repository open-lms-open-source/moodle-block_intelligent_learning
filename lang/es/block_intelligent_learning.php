...
$string['livegrades'] = 'Sincronización de Calificaciones en Vivo';
$string['ilpapi_url'] = 'URL de la API de ILP';
$string['ilpapi_urldesc'] = 'Ingresar el URL del sitio web de los servicios de ILP.';
$string['ilpapi_connectionid'] = 'ID de Conexión de la API de ILP';
$string['ilpapi_connectioniddesc'] = 'Ingresar el ID de Conexión de la API de ILP';
$string['ilpapi_connectionpassword'] = 'Contraseña de la Conexión de la API de ILP';
$string['ilpapi_connectionpassworddesc'] = 'Ingresar la contraseña de la conexión de la API de ILP.';
